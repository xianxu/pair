...
| `Couch.PrepareStart` | `cmd/internal/couchcore/couch.go`, `cmd/internal/couchcore/startargs.go`, `cmd/internal/couchcore/startgrant.go` | new | M1 | present | start arguments and resolution preview |
| `Couch.SpawnPrepared` | `cmd/internal/couchcore/couch.go`, `cmd/internal/couchcore/registry.go`, `cmd/internal/couchcore/runner.go`, `cmd/internal/couchcore/startargs.go`, `cmd/internal/couchcore/startgrant.go`, `cmd/internal/couchcore/worktree.go` | new | M1 | present | fingerprint re-resolution, worktree/registry state, and runner launch |
| `StartGrantStore` | `cmd/internal/couchcore/startgrant.go`, `cmd/internal/couchcore/clock.go` | new | M1 | deleted by pair#170 M4 | owner-local capability table, superseded by the start form's armed-submit identity plus SpawnPrepared's fingerprint re-resolution |
