...
4/ we should have a section of of brief arc of the whole thread, where we started, how it's side tracked to various topics. think about the underlying connections among those topics, and uncover user's latent intention among those pivots. Keep this concise. 
