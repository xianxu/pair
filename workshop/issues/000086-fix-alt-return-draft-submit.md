...
Pre-merge atlas judge caught stale review-poke documentation in `atlas/review-workbench.md` still describing raw `write 27 13` submit. Updated it to the semantic `send-keys --pane-id <agent> "Alt Enter"` contract and reran verification before pushing.
