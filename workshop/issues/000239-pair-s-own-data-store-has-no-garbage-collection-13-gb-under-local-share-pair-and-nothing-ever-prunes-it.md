...
- [x] M2 — Recoverable collection, preview/apply, bounded automatic sweep, verification and publication
...
- 2026-09-15: M2 acceptance evidence reconciled after M1 combined-implementation SHIP. Public CLI apply fixture verified expired collection, protected survivors and repeat idempotence (/tmp/pair-239-public-apply.log); real operator store preview only remained migration-blocked (/tmp/pair239-real-preview.json). Full Go and race suites passed, as did Lua/shell retention checks and complete isolated Zellij conformance. Hosted CI run34940937904 and merge-check run34940937781 pass at d7180a38. README/atlas cover all retention clocks, migration, managed-use entrypoints and recovery. No additional production changes since M1; M2 separately reviews acceptance and documentation as the recorded scope reconciliation requires.
