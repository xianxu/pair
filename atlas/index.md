...
`pair` is a small launcher that gives any TUI coding agent (Claude Code, Codex, Antigravity, Muse, Qoder) a Neovim-backed input field, decoupling the input scroll from the output scroll inside a zellij session.
