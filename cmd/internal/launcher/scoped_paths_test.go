...
func TestScopedPaths(t *testing.T) {
	...
	checks := map[string]string{
		...
		"LifecycleJournal":  scopeDir + "/lifecycle-work.jsonl",
	...
	got := map[string]string{
		...
		"LifecycleJournal":  paths.LifecycleJournal(),
...
func TestOwnsTagArtifactCoversEveryScopedTagConstructor(t *testing.T) {
	...
	for _, path := range []string{
		...
		paths.OuterTTY(), paths.LifecycleJournal(), paths.NvimDraftPID(), paths.NvimScrollbackPID(),
