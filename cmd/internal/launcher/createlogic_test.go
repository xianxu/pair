...
func TestExtractExplicitResume(t *testing.T) {
	cases := []struct {
		...
		{"claude valueless resume", "claude", []string{"--resume", "--model", "m"}, ""},
		...
		{"qoder space form", "qoder", []string{"--resume", "sid-q"}, "sid-q"},
		{"qoder short form", "qoder", []string{"-r", "sid-q"}, "sid-q"},
		{"qoder inline form", "qoder", []string{"--resume=sid-q"}, "sid-q"},
		{"qoder valueless resume", "qoder", []string{"--resume", "--model", "m"}, ""},
