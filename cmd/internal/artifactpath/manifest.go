...
var ResolvedBindings = append([]ResolvedBinding{
	...
	{Name: "direct-thread-claim-recognition", Family: "thread-claim", Resolver: "TagFromThreadClaim"},
	...
	{Name: "composite-pane-glob", Family: "pane", Resolver: "Resolve", Member: "PaneGlob"},
...
var SourceClassifications = []SourceClassification{
	...
	{Path: "cmd/internal/couchcore/artifactcollision.go", Kind: ResolvedConsumer,
		Families: []string{"session-binding", "pane"}, BindingNames: []string{"composite-scope-session-binding", "composite-pane-glob"}},
	...
	{Path: "cmd/internal/launcher/osruntime.go", Kind: ResolvedConsumer,
		...
		Vocabulary: []VocabularyAllowance{
			goCallVocabulary("config", "--config-dir", "os/exec.Command", 1, 1),
			goCallVocabulary("config", "--config-dir", "os/exec.CommandContext", 2, 1),
		}},
	...
	{Path: "cmd/internal/wrapcmd/wrap.go", Kind: ResolvedConsumer,
		Families:     []string{"agent", "agent-pid", "agent-ready", "config", "image-capture", "pair-wrap-pid", "wrap-events"},
		BindingNames: []string{"scoped-agent-output", "scoped-agent-pid", "scoped-agent-ready", "scoped-config", "scoped-image-capture", "scoped-pair-wrap-pid", "scoped-wrap-events"},
		Vocabulary: []VocabularyAllowance{
	...
	{Path: "cmd/internal/runtimebundle/assets/runtime/files/terminfo/70/pair-vt-256color", Kind: GeneratedMirror},
	...
	{Path: "cmd/internal/runtimebundle/assets/runtime/files/nvim/lifecycle_command.lua", Kind: GeneratedMirror},
...
var NonArtifactSources = []string{
	...
	"cmd/internal/termcmd/presentation.go",
	"cmd/internal/couchtty/terminal.go",
	...
	"cmd/internal/terminal/input.go",
	"cmd/internal/terminal/profile.go",
	"cmd/internal/terminal/profile_query.go",
	"cmd/internal/terminal/render.go",
	"cmd/internal/terminal/transport.go",
	"cmd/internal/terminal/view.go",
	"cmd/internal/terminalqualify/endpoint_cases.go",
	"cmd/internal/ttyio/fake.go",
	"cmd/internal/ttyio/writer.go",
	...
	"cmd/internal/couchcore/panebirth.go",
	...
	"cmd/internal/couchcore/startcleanup.go",
	"cmd/internal/couchcore/startresolution.go",
	"cmd/internal/couchcore/startup.go",
	"cmd/internal/couchcore/starttransaction.go",
	// Slot identity, lifecycle and local Couch metadata are not Pair's
	// tag-bearing artifact paths; the native scanner above is classified.
	"cmd/internal/couchcore/slot.go",
	"cmd/internal/couchcore/slotallocation.go",
	"cmd/internal/couchcore/slotcatalog.go",
	"cmd/internal/couchcore/slotcatalog_fake.go",
	"cmd/internal/couchcore/slotgit.go",
	"cmd/internal/couchcore/slotcontext.go",
	"cmd/internal/couchcore/slotinventory.go",
	"cmd/internal/couchcore/slotlaunch.go",
	"cmd/internal/couchcore/slotmigration.go",
	"cmd/internal/couchcore/slotrecovery.go",
	...
	"cmd/internal/couchcore/threadstore_layout.go",
	"cmd/internal/couchcore/threadstore_location.go",
	"cmd/internal/couchcore/threadstore_preview.go",
	"cmd/internal/couchcore/threadstore_snapshot.go",
	"cmd/internal/couchcore/threadtarget.go",
	"cmd/internal/couchcore/threadtag.go",
	"cmd/internal/couchcore/workspaceref.go",
	...
	"cmd/internal/couchtty/console_slotgit.go",
	...
	"cmd/internal/notifytransport/transport.go",
	...
	"cmd/internal/launcher/birthwatch.go",
	...
	"cmd/internal/pairlifecycletest/zellij_stub.go",
	...
	"cmd/internal/resumeform/resumeform.go",
	...
	"cmd/internal/sessionwatch/lifecycle_event.go",
	...
	"cmd/probes/reattachcost/main.go",
