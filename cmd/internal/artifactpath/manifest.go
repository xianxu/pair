...
var SourceClassifications = []SourceClassification{
	...
	{Path: "cmd/internal/sessioninventory/event.go", Kind: VocabularyConsumer, Families: []string{"queue"}, Vocabulary: []VocabularyAllowance{
		goCaseVocabulary("queue", "queue-operation", "normalizeClaudeEvent", 1),
	}},
	...
	{Path: "cmd/internal/launcher/osruntime.go", Kind: ResolvedConsumer,
		Families:     []string{"agent", "config", "draft", "ledger", "nvim-pid", "outer-tty", "parked", "parked-scrollback", "restart", "scrollback", "session-binding", "title-pid"},
		BindingNames: []string{"cache-restart", "scoped-agent", "scoped-config-glob", "scoped-draft", "scoped-ledger", "scoped-nvim-pid", "scoped-outer-tty", "scoped-parked", "scoped-parked-scrollback", "scoped-scrollback", "selected-nvim-pid", "selected-session-binding", "scoped-title-pid"},
	...
	{Path: "cmd/internal/sessioninventory/pair_inventory.go", Kind: ResolvedConsumer,
		Families: []string{"config", "ledger", "log"}, BindingNames: []string{"direct-config-sidecar", "direct-ledger-history", "direct-ledger-history-tag", "direct-log-history", "direct-log-history-tag"},
...
var NonArtifactSources = []string{
	...
	"cmd/internal/sessioninventory/runtime_os.go",
