...
var SourceClassifications = []SourceClassification{
	...
	{Path: "cmd/internal/launcher/osruntime.go", Kind: ResolvedConsumer,
		Families:     []string{"agent", "draft", "ledger", "nvim-pid", "outer-tty", "parked", "parked-scrollback", "restart", "scrollback", "session-binding", "title-pid"},
		BindingNames: []string{"cache-restart", "scoped-agent", "scoped-draft", "scoped-ledger", "scoped-nvim-pid", "scoped-outer-tty", "scoped-parked", "scoped-parked-scrollback", "scoped-scrollback", "selected-nvim-pid", "selected-session-binding", "scoped-title-pid"},
